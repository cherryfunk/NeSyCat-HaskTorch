...
module B_Logical.C_Category.Lukasiewicz where

import B_Logical.C_Category.DATA (DATA (..))
import A_Categorical.C_Category.Monads.Expectation (HasExpectation (..))
import A_Categorical.C_Category.Monads.Giry (Giry (..))
import C_NonLogical.C_Category.Supremum (enumAll, inf, sup)
