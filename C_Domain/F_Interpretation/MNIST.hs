...
module C_Domain.F_Interpretation.MNIST
  ( mnistTable,
    mnistMapDATA,
    mnistTableTENS,
    setGlobalMLP,
    module C_Domain.D_Theory.MnistTheory,
    module C_Domain.F_Interpretation.MNIST_MLP,
  )
where

import B_Logical.B_Vocabulary.TensVocab ()
import C_Domain.D_Theory.MnistTheory (ImagePairRow (..), MnistBridge (..), MnistTheory (..))
