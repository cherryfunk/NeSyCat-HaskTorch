...
module B_Interpretation.C_NonLogical.BinaryReal
  ( setGlobalBinaryMLP,
    module A_Syntax.C_NonLogical.BinaryVocab,
    module B_Interpretation.C_NonLogical.BinaryRealMLP,
  )
where

import A_Syntax.B_Logical.TENS_Vocab ()
import A_Syntax.C_NonLogical.BinaryVocab (Binary_Bridge (..), Binary_Vocab (..))
...
import qualified B_Interpretation.B_Logical.Boolean as BoolLogic
import B_Interpretation.B_Logical.TensReal hiding (Omega, TENS)
import qualified B_Interpretation.B_Logical.TensReal as TensLogic
import B_Interpretation.C_NonLogical.BinaryRealMLP (Binary_MLP, binarySpecReal, hThetaReal)
