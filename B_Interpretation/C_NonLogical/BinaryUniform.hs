...
module B_Interpretation.C_NonLogical.BinaryUniform
  ( setGlobalBinaryMLP,
    module A_Syntax.C_NonLogical.BinaryVocab,
    module B_Interpretation.C_NonLogical.BinaryUniformMLP,
  )
where
...
import B_Interpretation.B_Logical.Tensor hiding (Omega, TENS)
import qualified B_Interpretation.B_Logical.Tensor as TensLogic
import B_Interpretation.C_NonLogical.BinaryUniformMLP (Binary_MLP, binarySpec, hTheta)
