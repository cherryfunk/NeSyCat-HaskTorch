...
module B_Interpretation.C_NonLogical.Weather where

import A_Syntax.C_NonLogical.Weather_Vocab (Worlds, WorldsRow (..))
import B_Interpretation.B_Typological.DATA (tableLookup)
