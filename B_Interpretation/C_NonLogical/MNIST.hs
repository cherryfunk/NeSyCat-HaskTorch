...
module B_Interpretation.C_NonLogical.MNIST
  ( mnistTable,
    mnistMapDATA,
    mnistTableTENS,
    setGlobalMLP,
    module A_Syntax.C_NonLogical.MNIST_Vocab,
    module B_Interpretation.C_NonLogical.MNIST_MLP,
  )
where

import A_Syntax.B_Logical.TENS_Vocab ()
import A_Syntax.C_NonLogical.MNIST_Vocab (ImagePairRow (..), MNIST_Bridge (..), MNIST_Vocab (..))
...
import B_Interpretation.C_NonLogical.MNIST_MLP (MLP, hTheta, mnistSpec)
