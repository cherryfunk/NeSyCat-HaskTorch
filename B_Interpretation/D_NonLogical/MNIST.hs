...
module B_Interpretation.D_NonLogical.MNIST
  ( mnistTable,
    mnistMapDATA,
    mnistTableTENS,
    setGlobalMLP,
    module A_Syntax.D_NonLogical.MNIST_Vocab,
    module B_Interpretation.D_NonLogical.MNIST_MLP,
  )
where

import A_Syntax.B_Typological.TENS_Vocab ()
import A_Syntax.D_NonLogical.MNIST_Vocab (ImagePairRow (..), MNIST_Bridge (..), MNIST_Vocab (..))
