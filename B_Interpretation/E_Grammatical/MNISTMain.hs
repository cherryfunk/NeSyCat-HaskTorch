...
import A_Syntax.D_NonLogical.MNIST_Vocab (ImagePairRow (..), MNIST_Vocab (..), MNIST_Bridge (..))
...
import B_Interpretation.C_Logical.Boolean hiding (Omega)
import B_Interpretation.D_NonLogical.MNIST (mnistTable)
import B_Interpretation.D_NonLogical.MNIST_MLP (MLP, hTheta)
import D_Inference.D_NonLogical.MNIST_Training (trainMNIST)
