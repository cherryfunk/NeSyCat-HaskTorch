...
import A_Syntax.D_NonLogical.MNIST_Vocab (ImagePairRow (..), MNIST_Vocab (Digit, Image, M, add, digit, digitEq, digitPlus))
import A_Syntax.E_Grammatical.Formulas (loadFormulas)
import B_Interpretation.B_Typological.DATA (DATA (..))
import B_Interpretation.C_Logical.Boolean
import B_Interpretation.D_NonLogical.Countable
import B_Interpretation.D_NonLogical.Crossing
import B_Interpretation.D_NonLogical.Dice
import B_Interpretation.D_NonLogical.MNIST (mnistTable)
import B_Interpretation.D_NonLogical.Weather
import C_Semantics.A_Categorical.Monads.Dist (Dist)
import C_Semantics.A_Categorical.Monads.Expectation (HasExpectation (..), probDist, probGiry)
