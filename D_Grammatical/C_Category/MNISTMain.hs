...
import B_Logical.C_Category.Boolean hiding (Omega)
import C_NonLogical.C_Category.MNIST (mnistTable)
import C_NonLogical.C_Category.MNIST_MLP (MLP, hTheta)
import E_Inference.C_NonLogical.MNIST_Training (trainMNIST)
import A_Categorical.C_Category.Monads.Expectation (probDist)
