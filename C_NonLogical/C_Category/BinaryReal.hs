...
module C_NonLogical.C_Category.BinaryReal
  ( setGlobalBinaryMLP,
    module C_NonLogical.A_Signature.BinarySig,
    module C_NonLogical.C_Category.BinaryRealMLP,
  )
where
...
import B_Logical.C_Category.TensReal hiding (Omega, TENS)
import qualified B_Logical.C_Category.TensReal as TensLogic
