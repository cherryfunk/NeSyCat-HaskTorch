...
module C_NonLogical.C_Category.BinaryUniform
  ( setGlobalBinaryMLP,
    module C_NonLogical.A_Signature.BinarySig,
    module C_NonLogical.C_Category.BinaryUniformMLP,
  )
where
...
import qualified B_Logical.C_Category.Boolean as BoolLogic
import B_Logical.C_Category.Tensor hiding (Omega, TENS)
import qualified B_Logical.C_Category.Tensor as TensLogic
import C_NonLogical.C_Category.BinaryUniformMLP (Binary_MLP, binarySpec, hTheta)
