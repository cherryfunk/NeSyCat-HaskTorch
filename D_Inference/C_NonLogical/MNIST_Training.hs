...
module D_Inference.C_NonLogical.MNIST_Training
  ( trainMNIST,
  )
where

import A_Syntax.C_NonLogical.MNIST_Vocab (MNIST_Vocab (..))
import B_Interpretation.B_Typological.TENS (TENS (..))
import B_Interpretation.C_NonLogical.MNIST (mnistTableTENS, setGlobalMLP)
