...
--   D_Inference.B_Logical.BetaTrainingReal (the β update step).
--
--   Architecture:
...
module D_Inference.C_NonLogical.BinaryTrainingRealBeta
  ( trainBinaryRealBeta,
  )
where

import A_Syntax.C_NonLogical.BinaryVocab (Binary_Vocab (..))
import qualified B_Interpretation.B_Logical.Tensor as TENS
import B_Interpretation.C_NonLogical.BinaryReal (setGlobalBinaryMLP)
import B_Interpretation.C_NonLogical.BinaryRealMLP (Binary_MLP, binarySpecReal, hThetaReal)
import D_Inference.B_Logical.BetaTrainingReal (stepBeta)
