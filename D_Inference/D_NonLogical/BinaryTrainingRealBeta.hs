...
--   D_Inference.C_Logical.BetaTrainingReal (the β update step).
--
--   Architecture:
...
module D_Inference.D_NonLogical.BinaryTrainingRealBeta
  ( trainBinaryRealBeta,
  )
where
...
import D_Inference.C_Logical.BetaTrainingReal (stepBeta)
