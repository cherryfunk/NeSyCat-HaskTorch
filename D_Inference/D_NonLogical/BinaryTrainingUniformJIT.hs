...
module D_Inference.D_NonLogical.BinaryTrainingUniformJIT
  ( trainBinaryUniformJIT,
  )
where

import B_Interpretation.D_NonLogical.BinaryUniformMLP (Binary_MLP, binarySpec)
import B_Interpretation.D_NonLogical.BinaryUniform (setGlobalBinaryMLP)
import qualified B_Interpretation.C_Logical.TensUniform as TENS
